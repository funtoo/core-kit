...
SRC_URI="
https://www.kernel.org/pub/software/scm/git/git-2.36.1.tar.xz
https://www.kernel.org/pub/software/scm/git/git-manpages-2.36.1.tar.xz"
KEYWORDS="*"
...
src_unpack() {
	unpack git-2.36.1.tar.xz
	cd "${S}" || die
	unpack git-manpages-2.36.1.tar.xz
	if use doc ; then
