...
SRC_URI="
https://www.kernel.org/pub/software/scm/git/git-2.42.0.tar.xz -> git-2.42.0.tar.xz
https://www.kernel.org/pub/software/scm/git/git-manpages-2.42.0.tar.xz -> git-manpages-2.42.0.tar.xz"
KEYWORDS="*"
...
src_unpack() {
	unpack git-2.42.0.tar.xz
	cd "${S}" || die
	unpack git-manpages-2.42.0.tar.xz
	if use doc ; then
