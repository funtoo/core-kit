...
SRC_URI="
https://www.kernel.org/pub/software/scm/git/git-2.31.0.tar.xz
https://www.kernel.org/pub/software/scm/git/git-manpages-2.31.0.tar.xz"
KEYWORDS="*"
...
src_unpack() {
	unpack git-2.31.0.tar.xz
	cd "${S}" || die
	unpack git-manpages-2.31.0.tar.xz
	if use doc ; then
