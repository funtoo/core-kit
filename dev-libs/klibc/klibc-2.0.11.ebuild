...
SRC_URI="https://git.kernel.org/pub/scm/libs/klibc/klibc.git/snapshot/klibc-2.0.11.tar.gz -> klibc-2.0.11.tar.gz https://cdn.kernel.org/pub/linux/kernel/v5.x/linux-5.19.tar.xz -> linux-5.19.tar.xz"
