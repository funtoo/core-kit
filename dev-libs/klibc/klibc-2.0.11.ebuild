...
SRC_URI="https://git.kernel.org/pub/scm/libs/klibc/klibc.git/snapshot/klibc-2.0.11.tar.gz -> klibc-2.0.11.tar.gz https://cdn.kernel.org/pub/linux/kernel/v6.x/linux-6.0.tar.xz -> linux-6.0.tar.xz"
