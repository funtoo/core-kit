...
src_prepare() {
	...
	epatch "${FILESDIR}"/${P}-gcc-include-fix.patch
	epatch "${FILESDIR}"/${P}-sysmacros.patch #fix build on newer glibc
	epatch "${FILESDIR}"/${P}-glibc-2.26.patch #fix build specifically with glibc-2.26
