...
SRC_URI="http://www.linux-pam.org/library/${MY_P}.tar.bz2
	...
	https://releases.pagure.org/pam-redhat/${REDHAT_PAM}.tar.bz2"
...
multilib_src_configure() {
	# Do let user's BROWSER setting mess us up. #549684
	unset BROWSER
