...
PATCHES=(
	...
	"${FILESDIR}/cve-backports/cve-fixes.diff" 
	"${FILESDIR}/cve-backports/more-cve-fixes.diff"
	"${FILESDIR}/cve-backports/cve-2017-13733.diff"
	"${FILESDIR}/cve-backports/cve-2017-16879.diff"
)
