...
SRC_URI+=" mirror://funtoo/${P}-patches-${PATCH_VER}.tar.bz2"
SRC_URI+=" multilib? ( mirror://funtoo/gcc-${GCC_BOOTSTRAP_VER}-multilib-bootstrap.tar.bz2 )"

IUSE="audit caps debug doc gd hardened multilib nscd selinux systemtap profile suid vanilla headers-only test"
...
src_prepare() {
	...
	# Add x86 makecontext alignment patch and test.
	eapply "${FILESDIR}/2.26/i386-makecontext-align-stack-on-exit.patch"
	sed -e 's/tst-mkakecontext/& tst-makecontext-align/' -i stdlib/Makefile || die
