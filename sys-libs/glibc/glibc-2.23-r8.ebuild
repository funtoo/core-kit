...
eblit-src_prepare-post() {
	...
	epatch "${FILESDIR}"/${PN}-2.23-binutils-2.29.patch
	epatch "${FILESDIR}"/CVE-2017-16997.patch
	epatch "${FILESDIR}"/2.19/${PN}-2.19-ia64-gcc-4.8-reloc-hack.patch #503838
	epatch "${FILESDIR}"/${PN}-2.23-ttyname.patch # fixes ttyname issues, which messing screen start in LXD containers
	epatch "${FILESDIR}"/2.23/CVE-backports/cvs-compute-correct-array-size-in-_dl_init_paths.diff
	epatch "${FILESDIR}"/2.23/CVE-backports/cvs-count-components-of-expanded-path-in-_dl_init_paths.diff
	epatch "${FILESDIR}"/2.23/CVE-backports/cvs-fix-glob-buffer-overflow.diff
	epatch "${FILESDIR}"/2.23/CVE-backports/cvs-fix-one-byte-glob-overflow.diff
	epatch "${FILESDIR}"/2.23/CVE-backports/cvs-make-getcwd-fail-if-path-is-no-absolute.diff
	epatch "${FILESDIR}"/2.23/CVE-backports/glibc-2.23-cve-2018-6485-6551.patch
