...
DEPEND="${PYTHON_DEPS}"
RDEPEND="${DEPEND} >=sys-boot/grub-2.00-r5[binfont] x86? ( sys-firmware/intel-microcode sys-apps/iucode_tool ) amd64? ( sys-firmware/intel-microcode sys-apps/iucode_tool )"
