...
SRC_URI="https://github.com/vaeth/eix/releases/download/v0.36.9/eix-0.36.9.tar.xz -> eix-0.36.9.tar.xz"
...
src_prepare() {
	...
	sed -e "s#Push -c emergecmd 'emerge' '--sync'#Push -c emergecmd 'ego' 'sync'#" \
		-i src/eix-sync.sh.in || die
