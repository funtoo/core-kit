...
EGO_SUM=(
	...
	"github.com/urfave/cli/v2 v2.15.0/go.mod"
	...
	"golang.org/x/sys v0.0.0-20220909162455-aba9fc2a8ff2/go.mod"
...
SRC_URI="https://api.github.com/repos/gopasspw/gopass/tarball/v1.14.6 -> gopass-1.14.6.tar.gz
	${EGO_SUM_SRC_URI}"
