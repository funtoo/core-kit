...
EGO_SUM=(
	...
	"golang.org/x/crypto v0.0.0-20220312131142-6068a2e6cfdc/go.mod"
	...
	"golang.org/x/exp v0.0.0-20220312040426-20fd27f61765/go.mod"
...
SRC_URI="https://api.github.com/repos/gopasspw/gopass/tarball/v1.14.0 -> gopass-1.14.0.tar.gz
	${EGO_SUM_SRC_URI}"
