...
EGO_SUM=(
	...
	"github.com/urfave/cli/v2 v2.23.5/go.mod"
	...
	"golang.org/x/exp v0.0.0-20221108223516-5d533826c662/go.mod"
...
SRC_URI="https://api.github.com/repos/gopasspw/gopass/tarball/v1.14.10 -> gopass-1.14.10.tar.gz
	${EGO_SUM_SRC_URI}"
