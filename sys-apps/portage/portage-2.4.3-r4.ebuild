...
#FL-3333 and #FL-3687 are covered in the add-sync-branch-and-sync-enforcing
#FL-3755

PATCHES=(
	"${FILESDIR}/${PN}-${PV}-sync-branch-sync-enforcing.patch"
	"${FILESDIR}/${PN}-add-ceresia-distfile-mirrors.patch"
	"${FILESDIR}/${PN}-${PV}-remove-gentoo-repos-conf.patch"
)
python_prepare_all() {
