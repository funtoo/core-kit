...
src_prepare() {
	cd ..
	# add much more security backports not covered before. FL-4634
	...
	epatch "${FILESDIR}/2015-5/0001-NFC-Fix-payload-length-validation-in-NDEF-record-par.patch"
	...
	epatch "${FILESDIR}/2017-1/0001-hostapd-Avoid-key-reinstallation-in-FT-handshake.patch"
	epatch "${FILESDIR}/2017-1/0002-Prevent-reinstallation-of-an-already-in-use-group-ke.patch"
	epatch "${FILESDIR}/2017-1/0003-Extend-protection-of-GTK-IGTK-reinstallation-of-WNM-.patch"
	epatch "${FILESDIR}/2017-1/0004-Fix-TK-configuration-to-the-driver-in-EAPOL-Key-3-4-.patch"
	epatch "${FILESDIR}/2017-1/0005-Prevent-installation-of-an-all-zero-TK.patch"
	epatch "${FILESDIR}/2017-1/0006-Fix-PTK-rekeying-to-generate-a-new-ANonce.patch"
	epatch "${FILESDIR}/2017-1/0007-TDLS-Reject-TPK-TK-reconfiguration.patch"
...
src_install() {
	...
	newinitd "${FILESDIR}"/${PN}-init.d.1 ${PN}
