...
PATCHES=(
	...
	# FL-5845. btpclient.c missing sygnal.h include.
...
multilib_src_install_all() {
	...
	# configure bluetooth to auto-enable devices.
	sed -i -e "s/^#AutoEnable=false/AutoEnable=true/g" "$D"/etc/bluetooth/main.conf || die
}
