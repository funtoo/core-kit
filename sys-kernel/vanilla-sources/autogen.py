...
async def generate(hub, **pkginfo):
	...
	if patch_ver is not None:
		artifacts.append(hub.pkgtools.ebuild.Artifact(url=f"https://mirrors.edge.kernel.org/pub/linux/kernel/v{major_ver}.x/patch-{major_ver}.{minor_ver}.{patch_ver}.xz"))
