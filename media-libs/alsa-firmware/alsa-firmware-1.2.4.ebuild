...
SRC_URI="https://www.alsa-project.org/files/pub/firmware/alsa-firmware-1.2.4.tar.bz2 -> alsa-firmware-1.2.4.tar.bz2"
...
src_install() {
	...
	use alsa_cards_usb-usx2y && udev_dorules ${REPODIR}/media-sound/files/${PN}/52-usx2yaudio.rules
}