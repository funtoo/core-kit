...
SRC_URI="
	amd64? (
		https://github.com/firecracker-microvm/firecracker/releases/download/v0.24.0/firecracker-v0.24.0-x86_64.tgz
	)
	arm64? (
		https://github.com/firecracker-microvm/firecracker/releases/download/v0.24.0/firecracker-v0.24.0-aarch64.tgz
	)"
...
src_install() {
	...
	newbin "${WORKDIR}/firecracker-v${PV}-${my_arch}" firecracker
	newbin "${WORKDIR}/jailer-v${PV}-${my_arch}" jailer
}
