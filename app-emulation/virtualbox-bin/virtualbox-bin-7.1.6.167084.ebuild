...
SRC_URI=" https://download.virtualbox.org/virtualbox/7.1.6/VirtualBox-7.1.6-167084-Linux_amd64.run -> VirtualBox-7.1.6-167084-Linux_amd64.run https://download.virtualbox.org/virtualbox/7.1.6/Oracle_VirtualBox_Extension_Pack-7.1.6-167084.vbox-extpack -> Oracle_VirtualBox_Extension_Pack-7.1.6-167084.tar.gz
...
src_unpack() {
	...
	unpack Oracle_VirtualBox_Extension_Pack-7.1.6-167084.tar.gz
	popd &>/dev/null || die
