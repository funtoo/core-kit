...
SRC_URI=" https://download.virtualbox.org/virtualbox/7.0.6/VirtualBox-7.0.6-155176-Linux_amd64.run -> VirtualBox-7.0.6-155176-Linux_amd64.run https://download.virtualbox.org/virtualbox/7.0.6/Oracle_VM_VirtualBox_Extension_Pack-7.0.6-155176.vbox-extpack -> Oracle_VM_VirtualBox_Extension_Pack-7.0.6-155176.tar.gz
	sdk? ( https://download.virtualbox.org/virtualbox/7.0.6/VirtualBoxSDK-7.0.6-155176.zip -> VirtualBoxSDK-7.0.6-155176.zip )"
...
RDEPEND="!app-emulation/virtualbox-additions
	~app-emulation/virtualbox-modules-7.0.6
	!headless? (
		dev-libs/glib
...
src_unpack() {
	unpack_makeself VirtualBox-7.0.6-155176-Linux_amd64.run
	unpack ./VirtualBox.tar.bz2

	mkdir "${S}"/Oracle_VM_VirtualBox_Extension_Pack || die
	pushd "${S}"/Oracle_VM_VirtualBox_Extension_Pack &>/dev/null || die
	unpack Oracle_VM_VirtualBox_Extension_Pack-7.0.6-155176.tar.gz
	popd &>/dev/null || die

	if use sdk ; then
		unpack VirtualBoxSDK-7.0.6-155176.zip
	fi
}
