...
SRC_URI=" https://download.virtualbox.org/virtualbox/6.1.24/VirtualBox-6.1.24-145767-Linux_amd64.run https://download.virtualbox.org/virtualbox/6.1.24/Oracle_VM_VirtualBox_Extension_Pack-6.1.24-145767.vbox-extpack -> Oracle_VM_VirtualBox_Extension_Pack-6.1.24-145767.tar.gz
	sdk? ( https://download.virtualbox.org/virtualbox/6.1.24/VirtualBoxSDK-6.1.24-145767.zip )"
...
src_unpack() {
	unpack_makeself VirtualBox-6.1.24-145767-Linux_amd64.run
	unpack ./VirtualBox.tar.bz2

	mkdir "${S}"/Oracle_VM_VirtualBox_Extension_Pack || die
	pushd "${S}"/Oracle_VM_VirtualBox_Extension_Pack &>/dev/null || die
	unpack Oracle_VM_VirtualBox_Extension_Pack-6.1.24-145767.tar.gz
	popd &>/dev/null || die

	if use sdk ; then
		unpack VirtualBoxSDK-6.1.24-145767.zip
	fi
}
