...
SRC_URI="https://github.com/moby/moby/tarball/1a7969545d73537545645f5cd2c79b7a77e7d39f -> moby-24.0.6-1a79695.tar.gz"
...
src_install() {
	...
	newinitd ${REPODIR}/app-emulation/files/${PN}/${PN}.initd ${PN}
	newconfd ${REPODIR}/app-emulation/files/${PN}/${PN}.confd ${PN}
