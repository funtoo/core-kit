...
SRC_URI="https://github.com/containerd/containerd/tarball/926c9586fe4a6236699318391cd44976a98e31f1 -> containerd-1.7.15-926c958.tar.gz"
...
src_compile() {
	...
	myemakeargs=(
		...
		REVISION="926c9586fe4a6236699318391cd44976a98e31f1"
		VERSION=v${PV}
	)
