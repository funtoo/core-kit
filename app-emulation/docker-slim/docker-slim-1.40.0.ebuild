...
EGO_SUM=(
	...
	"github.com/google/go-containerregistry v0.8.0/go.mod"
...
SRC_URI="https://api.github.com/repos/slimtoolkit/slim/tarball/1.40.0 -> docker-slim-1.40.0.tar.gz
	${EGO_SUM_SRC_URI}"
...
post_src_unpack() {
	mv "${WORKDIR}"/docker-slim-docker-slim-* "${S}" || die
}
