...
PATCHES=(
	...
	"${FILESDIR}"/0001-cgroups-initialize-cpuset-properly.patch # https://discuss.linuxcontainers.org/t/cannot-launch-containers-with-lxd-3-15-and-lxc-3-2-1/5346/4
)
