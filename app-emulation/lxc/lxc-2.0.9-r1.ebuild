...
src_prepare() {
	...
	eapply "${FILESDIR}"/2.0.0/0001-utils-add-LXC_PROC_PID_FD_LEN_stable-2.0.patch # this adds LXC_PROC_PID_FD_LEN
	eapply "${FILESDIR}"/2.0.0/CVE-2018-6556.patch # FL-5373.
	eapply_user
	eautoreconf
}
